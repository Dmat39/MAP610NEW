...
const AVAILABLE_LAYERS = [
  ...
  { key: 'pnpRoboAlPaso',            label: 'Robo al Paso',               group: 'Incidencias PNP' },
  { key: 'pnpRoboAgravado',          label: 'Robo Agravado',              group: 'Incidencias PNP' },
  { key: 'pnpDrogas',                label: 'Drogas PNP',                 group: 'Incidencias PNP' },
  { key: 'pnpViolenciaFamiliar',     label: 'Violencia Familiar',         group: 'Incidencias PNP' },
  { key: 'pnpAccidente',             label: 'Accidente de Tránsito',      group: 'Incidencias PNP' },
  { key: 'pnpViolenciaSexual',       label: 'Violencia Sexual',           group: 'Incidencias PNP' },
  { key: 'pnpHomicidio',             label: 'Homicidio PNP',              group: 'Incidencias PNP' },
  { key: 'pnpLesiones',              label: 'Lesiones PNP',               group: 'Incidencias PNP' },
  { key: 'pnpHurto',                 label: 'Hurto PNP',                  group: 'Incidencias PNP' },
  { key: 'pnpOtros',                 label: 'Otros PNP',                  group: 'Incidencias PNP' },
